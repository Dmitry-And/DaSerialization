...
namespace DaSerialization.Serialization
{
    ...
    public class UInt64ArraySerializer : AArraySerializer<UInt64>
    {
        ...
        protected override void WriteElement(UInt64 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class Int64ArraySerializer : AArraySerializer<Int64>
    {
        ...
        protected override void WriteElement(Int64 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class UInt32ArraySerializer : AArraySerializer<UInt32>
    {
        ...
        protected override void WriteElement(UInt32 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class Int32ArraySerializer : AArraySerializer<Int32>
    {
        ...
        protected override void WriteElement(Int32 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class UInt16ArraySerializer : AArraySerializer<UInt16>
    {
        ...
        protected override void WriteElement(UInt16 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class Int16ArraySerializer : AArraySerializer<Int16>
    {
        ...
        protected override void WriteElement(Int16 e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class ByteArraySerializer : AArraySerializer<Byte>
    {
        ...
        protected override void WriteElement(Byte e, BinaryStreamWriter writer) { writer.Write(e); }
    }
    ...
    public class SByteArraySerializer : AArraySerializer<SByte>
    {
        ...
        protected override void WriteElement(SByte e, BinaryStreamWriter writer) { writer.Write(e); }
    }
