...
namespace DaSerialization
{
    public static class BinarySerializationHelpers
    {
        ...
        public static Vector2Short ReadVector2Short(this BinaryReader reader)
        {
            Vector2Short v = new Vector2Short();
            v.x = reader.ReadInt16();
            v.y = reader.ReadInt16();
            return v;
        }

        public static Vector2Byte ReadVector2Byte(this BinaryReader reader)
        {
            Vector2Byte v = new Vector2Byte();
            v.x = reader.ReadByte();
            v.y = reader.ReadByte();
            return v;
        }

        public static Vector2SByte ReadVector2SByte(this BinaryReader reader)
        {
            Vector2SByte v = new Vector2SByte();
            v.x = reader.ReadSByte();
            v.y = reader.ReadSByte();
            return v;
        }
        ...
        public static void WriteVector2Short(this BinaryWriter writer, Vector2Short v)
        {
            writer.Write(v.x);
            writer.Write(v.y);
        }

        public static void WriteVector2Byte(this BinaryWriter writer, Vector2Byte v)
        {
            writer.Write(v.x);
            writer.Write(v.y);
        }

        public static void WriteVector2SByte(this BinaryWriter writer, Vector2SByte v)
        {
            writer.Write(v.x);
            writer.Write(v.y);
        }
